    ...
    <View style={styles.container}>
      ...
      <View style={styles.quizBox}>
        ...
        <View style={styles.questionBox}>
          <Text style={styles.questionText}>The part of the microscope that connects the base to the head and the eyepiece tube. It is used to carry the microscope.</Text>
        </View>
