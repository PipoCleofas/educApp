...
const Question10: React.FC = () => {
  ...
  const {handleBioQuizPress10} = useHandleClicks();
  ...
  const handleNextPress = async () => {
    ...
    try {
      if (selectedOption !== "D. Arm") Alert.alert("The correct answer is D.")
    ...
    <View style={styles.container}>
      ...
      <View style={styles.quizBox}>
        <View style={styles.questionBox}>
          <Text style={styles.questionText}>10. The part of the microscope that connects the base to the head and the eyepiece tube. It is used to carry the microscope.</Text>
        </View>
        <View style={styles.optionsContainer}>
          {['A. Draw Tube', 'B. Objective', 'C. Eyepiece', 'D. Arm'].map((option) => (
            <TouchableOpacity
              key={option}
