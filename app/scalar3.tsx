...
export default function Scalar() {
  ...
  const { handleNextBioPicsPress4 } = useHandleClicks();
  ...
  const handleNext = async () => {
    if (selectedOption) {
      try {
        ...
        handleNextBioPicsPress4(); // Navigate after saving
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Image */}
      <Image source={require("../utils/pictures/.54.jpg")} style={styles.image} />
