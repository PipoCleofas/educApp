...
const Question4: React.FC = () => {
  ...
  const handleNextPress = async () => {
    ...
    try {
      if (selectedOption !== "A. It increases the rate of dissolving.") Alert.alert("The correct answer is A.")
    ...
    <View style={styles.container}>
      ...
      <View style={styles.quizBox}>
        <View style={styles.questionBox}>
          <Text style={styles.questionText}>4. How does shaking or stirring a mixture of solute and solvent affect a solution?</Text>
        </View>
