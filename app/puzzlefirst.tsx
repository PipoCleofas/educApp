...
const PuzzleFirst = () => {
  ...
  const { handleGeoFirstPuzzlePress, setGeoPuzzle1 } = useHandleClicks();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.questionContainer}>
        ...
        <TextInput
          ...
          onChangeText={(text) => setGeoPuzzle1(text)}
        />

        <TouchableOpacity style={styles.nextButton} onPress={handleGeoFirstPuzzlePress}>
...
const styles = StyleSheet.create({
  ...
  scrambledText: {
    fontSize: 28,
    fontWeight: "bold",
    color: "#98d083", // Soft Green (Accent Color)
    textAlign: "center",
    marginBottom: 10,
  ...
  title: {
    fontSize: 35,
    fontWeight: "bold",
    color: "#f2feca", // Soft Yellow (for title)
    position: "absolute",
    top: "10%",
  },
  image: {
