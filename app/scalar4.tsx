...
export default function Scalar() {
  ...
  const { handleNextBioPicsPress5 } = useHandleClicks();
  ...
  const handleNext = async () => {
    if (selectedOption) {
      try {
        ...
        handleNextBioPicsPress5(); // Navigate after saving
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Image */}
      <Image source={require("../utils/pictures/.53.jpg")} style={styles.image} />
