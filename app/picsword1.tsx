  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        placeholderTextColor="#98D2C0" // Soft greenish color for placeholder
...
const styles = StyleSheet.create({
  container: {
    backgroundColor: "#205781", // Deep blue background color
    flex: 1,
    alignItems: "center",
  ...
  exitButton: {
    ...
    top: "5%",
    left: "5%",
    backgroundColor: "#98D2C0", // Light greenish background for the exit button
    paddingVertical: 10,
    paddingHorizontal: 15,
    borderRadius: 10,
  },
  exitText: {
    color: "#F6F8D5", // Off-white text color for the exit button
    fontSize: 14,
  },
  hintText: {
    fontSize: 18,
    fontWeight: "bold",
    color: "#F6F8D5", // Off-white text color for the hint
    marginBottom: 10,
  },
  hintHighlight: {
  ...
  textInput: {
    ...
    height: 50,
    borderWidth: 2,
    borderColor: "#4F959D", // Lighter teal for the text input border
    borderRadius: 10,
    paddingHorizontal: 15,
    fontSize: 16,
    color: "#F6F8D5", // Off-white text color
    backgroundColor: "#4F959D", // Lighter teal background for the text input
    marginBottom: 20,
    textAlign: "center",
  },
  nextButton: {
    marginTop: 20,
    backgroundColor: "#98D2C0", // Light greenish background for the next button
    paddingVertical: 12,
