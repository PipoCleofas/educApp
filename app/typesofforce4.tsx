...
export default function TypesofForce() {
  ...
  const { handleTypesOfForcwePress5 } = useHandleClicks();
  ...
  const handleNext = async () => {
    if (selectedOption) {
      try {
        ...
        await AsyncStorage.setItem("selectedQuantity4", selectedOption);
        handleTypesOfForcwePress5(); // Navigate after saving
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Image */}
      <Image source={require("../utils/pictures/.31.jpg")} style={styles.image} />
