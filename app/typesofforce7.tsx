...
export default function TypesofForce() {
  ...
  const { handleTypesOfForcwePress8 } = useHandleClicks();
  ...
  const handleNext = async () => {
    if (selectedOption) {
      try {
        ...
        handleTypesOfForcwePress8(); // Navigate after saving
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Image */}
      <Image source={require("../utils/pictures/.34.jpg")} style={styles.image} />
