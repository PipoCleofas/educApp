...
export default function PicsWord() {
  ...
  const { handleOrganellesPress1 } = useHandleClicks();
  ...
  const handleNext = async () => {
    if (selectedOption) {
      try {
        ...
        await AsyncStorage.setItem("selectedQuantity2", selectedOption2!);
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.card}>
          <View style={styles.hintBox}>
            <Text style={styles.hintText}>LELC AWLL</Text>
            <Text style={styles.hintSubText}>Provides support and protection.</Text>
          </View>
          <TextInput
        ...
        <View style={styles.card}>
          <View style={styles.hintBox}>
            <Text style={styles.hintText}>CLESUNU</Text>
            <Text style={styles.hintSubText}>Stores DNA, controls cell activities.</Text>
          </View>
          <TextInput
            style={styles.textInput}
            placeholder="Enter your answer"
