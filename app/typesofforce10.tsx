...
export default function TypesofForce() {
  ...
  const { handleTypesOfForceSubmit } = useHandleClicks();
  ...
  const handleNext = async () => {
    if (selectedOption) {
      try {
        ...
        handleTypesOfForceSubmit(); // Navigate after saving
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Image */}
      <Image source={require("../utils/pictures/.37.jpg")} style={styles.image} />
